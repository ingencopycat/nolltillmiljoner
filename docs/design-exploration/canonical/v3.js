...
const artObserver=new MutationObserver(()=>{
 ...
 document.querySelectorAll('.bar').forEach((e,i)=>{if(i<2){e.style.fill='var(--bar)';e.style.stroke='var(--bar-stroke)';e.style.strokeWidth='1.5';}});
 ...
 document.querySelectorAll('footer>span:first-child').forEach(e=>e.textContent='NTM / Visual System V3');
