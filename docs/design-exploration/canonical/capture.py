...
base=f'http://127.0.0.1:{server.server_port}/docs/design-exploration/canonical/'
...
with sync_playwright() as pw:
 ...
 for v in '1':
  ...
  page.wait_for_selector('html[data-art-ready=true]')
  assert '/canonical/' in page.url and 'surface=thesis' in page.url and 'variant=' not in page.url
  page.locator('[data-action=edit]').click()
