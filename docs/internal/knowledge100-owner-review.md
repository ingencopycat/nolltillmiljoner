...
4. Ask the exact CAGR/total-return comparison. Read `fragor-svar-forward-trailing-pe.html`; inspect the comparison axis and caveat. Ask `P/E vs P/S`: no synthesized comparison.
...
6. Ask `Är P/E 40 dyrt?`, `Ska jag köpa NVIDIA?`, and an unrelated question. Verify honest bounded abstention, not a definition presented as advice.
