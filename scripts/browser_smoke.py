...
class BrowserSmoke(unittest.TestCase):
    ...
    def test_knowledge_bank_search_links_and_accessibility(self):
        ...
        expect(p.locator('#knowledgeResults')).to_be_hidden()
        ...
        expect(p.locator('#knowledgeResults')).to_contain_text('0 av 0')
        ...
        count=p.evaluate("NTMKnowledgeCatalog.search('','macro').length")
        expect(p.locator('#knowledgeResults')).to_contain_text(f'{min(12,count)} av {count}')
