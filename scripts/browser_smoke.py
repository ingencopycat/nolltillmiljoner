...
class BrowserSmoke(unittest.TestCase):
    ...
    def test_knowledge_bank_search_links_and_accessibility(self):
        ...
        expect(p.locator('#knowledgeResults')).to_contain_text('29 av 29')
        ...
        expect(p.locator('#knowledgeResults')).to_contain_text('0 av 29')
        ...
        expect(p.locator('#knowledgeResults')).to_contain_text('4 av 29')
        ...
        try:
            ...
            expect(page.locator('[data-knowledge-card]')).to_have_count(29)
