...
try:
 ...
 for width in (1440,390):
  for theme in ('dark','light'):
   ...
   case.go('research.html?ticker=NVDA');p.locator('#thesis-text').fill('Min sparade tes. Jag följer bolagets investeringar och granskar vilka antaganden som håller.')
   p.locator('#thesis-review-date').fill('2020-01-01');p.locator('#thesisForm button[type=submit]').click()
